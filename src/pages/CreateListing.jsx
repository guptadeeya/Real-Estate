      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
            ...
            <div className="flex flex-wrap gap-6">
                ...
                <div className="flex items-center gap-2">
                    <input type="number" id="regular" min='1' max='10' required className="p-3 border border-gray-300 rounded-lg"/>
...

{
    formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
        ...
        <button type="button" className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 diabled:opacity-50">Create Listing</button>
        </div>
      </form>
    </main>
  )
